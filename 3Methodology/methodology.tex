...
\hline
\textbf{Dataset} & \textbf{Samples} & \textbf{Gender} & \textbf{Source} \\
\hline
...
\hline
\textbf{Total} & \textbf{4,882} & \textbf{Balanced} & \textbf{Multi-source} \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|r|c|}
\hline
\textbf{Gender} & \textbf{Samples} & \textbf{Percentage} \\
\hline
Female & 2,600 & 53.2\% \\
\hline
Male & 2,200 & 45.1\% \\
...
\begin{tabular}{|l|r|c|}
\hline
\textbf{Subset} & \textbf{Samples} & \textbf{Percentage} \\
\hline
Training & 3,417 & 70\% \\
\hline
Validation & 733 & 15\% \\
...
\label{tab:audio_characteristics}
\vspace{0.3cm}
\begin{tabular}{|l|l|}
\hline
