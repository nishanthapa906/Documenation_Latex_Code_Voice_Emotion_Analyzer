...
\newcommand{\theinstitute}{Pokhara University}
\newcommand{\thecampus}{Citizen College}
\newcommand{\thedepartment}{Department of Bachelor of Computer Application}
\newcommand{\thedepartmentAddress}{Pokhara University, Nepal}
\newcommand{\thedepartmentFullAddress}{Kumaripati, Lalitpur, Nepal}
\newcommand{\theprogramcoordinator}{Er. Nishan Khanal}
\newcommand{\thePrincipal}{Mr. Hari Krishna Aryal}
\newcommand{\theHOD}{Er. Nishan Khanal}




\title{Voice Emotion Analyzer}
\author{Arjun Thapa}
\newcommand{\theroll}{2021-1-53-0376}
\date{February,2026}
\newcommand{\thesupervisor}{Er. Nishan Khanal}
